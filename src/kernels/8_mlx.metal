...
struct GEMMKernel {
  ...
  static METAL_FUNC void run(
    ...
    // MNK unaligned loop
      ...
      short2 src_tile_dims(min((int)BN, (int)(N - c_col)), min((int)BM, (int)(M - c_row)));
...
kernel void matmul(
    ...
    using gemm_kernel = GEMMKernel<float, 32, 32, 16, 2, 2, false, false, false, true>;

    threadgroup float tgp_memory[gemm_kernel::tgp_mem_size];
